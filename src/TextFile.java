...
public class TextFile {
	...
	/**
	 * Text File constructor. Open a file for reading, or create a file for
	...
	/**
	 * Read in the next character from the input file This method is only valud
	 * for input files, and will throw an halt program execution if called on an
	 * outpt file.
	 * 
	...
	/**
	 * Write a character to an output file. This method is only valid for output
	 * files, and will halt execution if called on an input file.
	 * 
	 * @param c
	...
	/**
	 * Rewind the input file to the beginning, so we can reread the file. Only
	 * valid for input files.
	 */
	public void rewind() {
		try {
