...
public class BinaryFile {
	 ...
	 * exection of called on an output file.
	 * 
	...
	/**
	 * Read a bit froman input file. This method is only valid for input files,
	 * and will halt exeuction if called on an output file.
	 * 
